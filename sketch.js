...
var butterflyGroup,butterflyImg,butterfly;
var score;
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
     cloud = createSprite(250,100,40,10);
...
function spawnButterfly() {
  //write code here to spawn the clouds
  if (frameCount % 100 === 0) {
     butterfly = createSprite(10,100,40,10);
    butterfly.y = Math.round(random(10,100));
    butterfly.addImage(butterflyImg);
    butterfly.scale = 0.1;
    butterfly.velocityX = +3;
    
     //assign lifetime to the variable
    butterfly.lifetime = 134;
    
    //adjust the depth
    butterfly.depth = trex.depth;
    trex.depth = trex.depth + 1;
